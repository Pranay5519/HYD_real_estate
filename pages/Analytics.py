...
word_df = pd.read_csv("datasets/hyderabad_properties_outliers_treated.csv")
...
placeslatlong = pd.read_csv('datasets/hyderbad_places_latlong.csv')
...
st.dataframe(sec)
fig1 = px.scatter_mapbox(placeslatlong, lat="Latitude", lon="Longitude", color='title',
